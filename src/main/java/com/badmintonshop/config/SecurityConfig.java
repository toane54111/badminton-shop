...
import com.badmintonshop.security.CustomAuthenticationSuccessHandler;
import com.badmintonshop.security.CustomUserDetailsService;
import com.badmintonshop.security.StaffUserDetailsService;
import com.badmintonshop.security.StaffAuthenticationSuccessHandler;
...
public class SecurityConfig {
        ...
        private final StaffAuthenticationSuccessHandler staffAuthenticationSuccessHandler;
        ...
        public SecurityFilterChain adminSecurityFilterChain(HttpSecurity http, PasswordEncoder encoder)
                ...
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .hasAnyRole("SUPER_ADMIN", "SALE_STAFF", "STRINGING_STAFF",
                                                                "WAREHOUSE_STAFF", "CONTENT_STAFF")
                                                .requestMatchers("/admin/**").hasAnyRole("SUPER_ADMIN", "SALE_STAFF",
                                                                "STRINGING_STAFF", "WAREHOUSE_STAFF", "CONTENT_STAFF"))
                                .formLogin(form -> form
                                                .loginPage("/admin/login")
                                                .loginProcessingUrl("/admin/login")
                                                .successHandler(staffAuthenticationSuccessHandler)
